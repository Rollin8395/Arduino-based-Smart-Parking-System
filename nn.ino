...
#include <Wire.h> //allows to communicate I2C devices
#include <LiquidCrystal_I2C.h> //allows to control I2C displays with functions extremely similar to LiquidCrystal library
LiquidCrystal_I2C lcd(0x27,16,2);

Servo myservo;

#define ir_enter 2 //entry ir sensor
#define ir_back  4 //exit ir sensor
